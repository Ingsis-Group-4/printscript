...
class SpaceAfterColonRuleTest {
    ...
    fun testRuleWithSpaceAndShouldMoveSomeNodesAndExpressionNodeOneSpace(){
        ...
        val sumNode = SumNode(firstExpressionNode, secondExpressionNode, OperatorNode(Position(1, 18), Position(1, 18), OperatorType.SUM), Position(1, 16), Position(1, 20))
        ...
        val newSumNode = SumNode(newFirstExpressionNode, newSecondExpressionNode, OperatorNode(Position(1, 19), Position(1, 19), OperatorType.SUM), Position(1, 17), Position(1, 21))
        ...
        assertEquals(((result.statements[0] as VariableDeclarationNode).expression as SumNode).getLeft().getStart(), newFirstExpressionNode.getStart())
        assertEquals(((result.statements[0] as VariableDeclarationNode).expression as SumNode).getLeft().getEnd(), newFirstExpressionNode.getEnd())
        assertEquals(((result.statements[0] as VariableDeclarationNode).expression as SumNode).getRight().getStart(), newSecondExpressionNode.getStart())
        assertEquals(((result.statements[0] as VariableDeclarationNode).expression as SumNode).getRight().getEnd(), newSecondExpressionNode.getEnd())
    }
    @Test
    fun testRuleWithSpaceAndShouldMoveMoreThanOneSpace(){
        ...
        val sumNode = SumNode(firstExpressionNode, secondExpressionNode, OperatorNode(Position(1, 21), Position(1, 21), OperatorType.SUM), Position(1, 19), Position(1, 23))
        val expressionNode = sumNode
        val variableDeclarationNode =
            VariableDeclarationNode(
                identifierNode,
        ...
        assertIs<SumNode>((result.statements[0] as VariableDeclarationNode).expression)
        assertEquals(((result.statements[0] as VariableDeclarationNode).expression as SumNode).getLeft().getStart(), firstExpressionNode.getStart())
        assertEquals(((result.statements[0] as VariableDeclarationNode).expression as SumNode).getLeft().getEnd(), firstExpressionNode.getEnd())
        assertEquals(((result.statements[0] as VariableDeclarationNode).expression as SumNode).getRight().getStart(), secondExpressionNode.getStart())
        assertEquals(((result.statements[0] as VariableDeclarationNode).expression as SumNode).getRight().getEnd(), secondExpressionNode.getEnd())
    }
    @Test
